...
func (u *ui) onGenerateTitles(r *http.Request) string {
	...
	return shared.SuccessPopupWithRedirect(
		successMessage,
		shared.NewLinksFromRequest(r).AiTitleGenerator(nil),
		5,
	).ToHTML()
}
...
func (u *ui) stepHandlerFindExistingTitles(ctx context.Context, data map[string]any) (context.Context, map[string]any, error) {
	...
	postList, err := u.Store().PostList(ctx, blogstore.PostQueryOptions{})
	if err != nil {
...
func (u *ui) stepHandlerGenerateTitles(ctx context.Context, data map[string]any) (context.Context, map[string]any, error) {
	...
	blogTopic, err := u.loadBlogTopic(ctx)
	if err != nil {
...
func (u *ui) loadBlogTopic(ctx context.Context) (string, error) {
...
func (u *ui) stepHandlerSaveTitles(ctx context.Context, data map[string]any) (context.Context, map[string]any, error) {
	...
	for _, title := range titles {
		...
		if err := u.CustomStore().RecordCreate(record); err != nil {

...
func (u *ui) onRegenerateSection(data pageData) string {
	...
	if err != nil {
		u.Logger().Error("BlogAi. Post Editor. Regenerate Section. Failed to regenerate section", slog.String("error", err.Error()))
